...
from apps.sale.infra.forms import CustomerForm, InvoiceForm
from apps.sale.infra.formsets import InvoiceLineFormset
from apps.sale.infra.models import Customer, Invoice, InvoiceLine
